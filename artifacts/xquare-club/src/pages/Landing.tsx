        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/50 text-sm">
              <li>
                <a href="tel:+919567089117" className="flex items-center gap-2 hover:text-white transition-colors">
              ...
              <li>
                <a href="mailto:hello@xquareclub.com" className="flex items-center gap-2 hover:text-white transition-colors">
